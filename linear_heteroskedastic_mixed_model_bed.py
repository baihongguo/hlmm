...
def parameter_covariance(pars,y,X,V,G,dx):
    ...
    Lambda=np.identity(l,float)+h2*G_scaled_T.dot(G)
...
if __name__ == "__main__":
    ...
    parser.add_argument('--missing_char',type=str,help='Missing value string in phenotype file',defaul='NA')
    ...
    if not args.mean_covar==None:
        ...
        args.fixed_mean_names=np.array(mean_covar_f.iid,dtype='S20')
        # Match with geno_ids
